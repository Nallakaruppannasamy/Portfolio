...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function hexToRGB(hex: string): ColorRGB {
      ...
      // Precision balancing tuned to 0.04 to secure perfect background layout legibility
      return { r: r * 0.04, g: g * 0.04, b: b * 0.04 };
    }
    ...
    function generateColor(): ColorRGB {
      ...
      // Scaled down to 0.04 to gracefully dim bright WebGL light reflections during reading
      c.r *= 0.04;
      c.g *= 0.04;
      c.b *= 0.04;
      return c;
